...
exports.traderJoeValidator = void 0;
exports.validateTraderJoeEvaluation = validateTraderJoeEvaluation;
/*
  We allow calls like:
...
class TraderJoeValidator {
    async validateEvaluation(...args) {
        ...
        if (!routerValid)
            warnings.push('Router address not supplied or invalid');
        if (!factoryValid)
            warnings.push('Factory address not supplied or invalid');
...
exports.traderJoeValidator = new TraderJoeValidator();
// Export the validation function expected by tests
function validateTraderJoeEvaluation(...args) {
    return exports.traderJoeValidator.validateEvaluation(...args);
}
//# sourceMappingURL=traderJoeValidation.js.map