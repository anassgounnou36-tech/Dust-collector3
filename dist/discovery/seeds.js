...
exports.SAMPLE_SEED_WALLETS = void 0;
exports.seedWallets = seedWallets;
exports.getProtocolUsers = getProtocolUsers;
exports.getTokenHolders = getTokenHolders;
exports.getLiquidityProviders = getLiquidityProviders;
exports.isValidAddress = isValidAddress;
exports.filterValidWallets = filterValidWallets;
...
async function seedWallets() {
    ...
    console.log(`Returning ${exports.SAMPLE_SEED_WALLETS.length} sample seed wallets`);
    return [...exports.SAMPLE_SEED_WALLETS];
}
async function getProtocolUsers(protocolName, chain) {
    ...
    return exports.SAMPLE_SEED_WALLETS.filter(wallet => wallet.chain === chain);
}
async function getTokenHolders(tokenAddress, chain, _minBalance) {
    ...
    return exports.SAMPLE_SEED_WALLETS.filter(wallet => wallet.chain === chain).slice(0, 3);
}
async function getLiquidityProviders(poolAddress, chain) {
    ...
    return exports.SAMPLE_SEED_WALLETS.filter(wallet => wallet.chain === chain).slice(0, 2);
}
...
function filterValidWallets(wallets) {
